...
Pupil_delay = fillPupil.DelayWindow;
Pupil_reward = fillPupil.RewardWindow;


Pupil_plot.Pupil_stim = Pupil_stim;
Pupil_plot.Pupil_baseline = Pupil_baseline;
Pupil_plot.Pupil_arousal = Pupil_arousal;
Pupil_plot.Pupil_delay = Pupil_delay;
Pupil_plot.Pupil_reward = Pupil_reward;

Pupil_plot.Outcome = raw_data.Rewarded;
Pupil_plot.Choice = raw_data.ResponseSide;
