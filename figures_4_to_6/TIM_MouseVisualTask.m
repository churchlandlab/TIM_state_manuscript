%% This script is designed to calculate the TIM values of the mice trained to do the visual task (task 2 in Methods),
%% and calculate the correlation between task performance, TIM, motion energy, and pupil size.
%% To run this script, the preprocessed DLC-tracking, behavioral, and pupil data from the animals are required.
